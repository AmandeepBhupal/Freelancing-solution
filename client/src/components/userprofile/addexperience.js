...
import { addUserExperience } from '../../actions';
...
class AddExperience extends Component {
    ...
    onSubmit(values) {
        this.props.addUserExperience(values, () => window.$('#addExperienceModal').modal('hide'));
    };
...
function validate(values) {
    ...
    if (!values.duration) {
        errors.duration = 'This field cannot be empty.';
    }

    return errors
}

export default reduxForm({ validate, form: 'AddExperienceForm' })(connect(null, { addUserExperience })(AddExperience));